...
Route::group([
    ...
    Route::post('/login', [AuthController::class, 'login'])->name('login')->middleware(TowFactor::class);
    Route::post('/logout', [AuthController::class, 'logout'])->middleware('auth:api')->name('logout');
    Route::post('/refresh', [AuthController::class, 'refresh'])->middleware('auth:api')->name('refresh');
    Route::post('/me', [AuthController::class, 'me'])->middleware('auth:api',TowFactor::class)->name('me');
});

Route::middleware([UserStatus::class,TowFactor::class])->group(function (){
...
Route::middleware([TowFactor::class])->group(function(){
    ...
    Route::get('/trend',[PostController::class,'showTrendPosts']);
    //////////////////////////////////////////////////////////////////////////////////////
